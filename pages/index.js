      ...
      <main className=" px-10 ">
        ...
        <section className={`${styles.transparentPink} min-h-screen`}>
          ...
          <div className="text-center p-10">
            ...
            <div className={`${styles.clipNotch} text-lg py-5 leading-8 text-purple-950 border-2 p-6 border-fuchsia-700 clip-notch`}>
                <p>
                  My journey led me to the passion of web-development after obtaining degrees in economics and supply chain management, and navigating through a variety of jobs. Upon realizing this passion, I started on a journey at Lighthouse Labs Bootcamp, immersing myself in an intensive exploration of the world of coding.
                </p>
                <p>
                My previous education and experiences have uniquely equipped me for my current role as a <span class="font-bold">web developer</span>. With a diverse background melding skills from various disciplines, I am eager to channel my enthusiasm into new projects and contributing to a dynamic team.
                </p>
            </div>
          </div>
          ...
          <div className="text-3xl py-1">
            ...
            <div className={`min-w-min py-10 px-10 mb-12 flex justify-between ${styles.techStacks} ${isMobile ? styles.techStacksMobile : ''}`}>
              <div className={`${styles.clipNotch} flex justify-center border-fuchsia-700 items-center py-2 px-5 h-full flex-col text-center shadow-lg p-10 `}>
                ...
                <ul className=" text-purple-800 text-xl">
                  <li>JavaScript</li>
                  <li>Python</li>
                  <li>Ruby</li>
                  <li>SQL</li>
              ...
              <div className={`${styles.clipNotch} flex justify-center border-fuchsia-700 items-center py-2 px-5 h-full flex-col text-center shadow-lg p-10`}>
                ...
                <ul className="py-3 text-purple-800 text-xl">
                  <li>Node</li>
                  <li>React</li>
                  <li>Next.js</li>
                  <li>Vite</li>
              ...
              <div className={`${styles.clipNotch} flex justify-center border-fuchsia-700 items-center py-2 px-5 h-full flex-col text-center shadow-lg p-10`}>
                ...
                <ul className="py-3 px-3  text-purple-800 text-xl">
                  <li>Sequelize</li>
                  <li>Prisma</li>
                  <li>Git</li>
                  <li>Mocha</li>
